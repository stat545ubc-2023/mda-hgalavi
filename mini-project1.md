...
My choice is **cancer_sample** dataset; This data set contains a sample
of quantitative features that were calculated from images of nuclei
present in fine needle aspiration biopsies of breast masses from
patients at the University of Wisconsin Hospital. . The reason I’ve
chosen this dataset is that I’ve had a personal experience with the loss
of my grandmother to [Breast
...
dataset.![](https://www.emro.who.int/images/stories/ncds/bcam_2022_banner.jpg)
<!----------------------------------------------------------------------------->
...
Association between diagnosis status (**malignant** or **benign**) and
...
1.  Plot the distribution of a numeric variable. \####2.1.1 I would like
    to have the plot of Mean radius of nuclei present in sample image.
...
2.  Create a new variable based on other variables in your data (only if
    it makes sense) In this dataset, it appears that each patient has
    several images of nuclei present in fine needle aspiration biopsies
    of breast cancer. Consequently, for each variable, I observe both
    the **mean** and the **standard error**. Therefore, I would like to
    generate a new type of variable that contains the sum of these two
    types. I refer to this variable as a **‘real’** variable because it
    includes both the mean and the standard error. Also in diagnosis
    variable “B” stand for benign and “M” is the abbreviation of
    malignant, I would like to have the compele name in the new dataset,
    which I refer to this dataset as a **real_dataset**.
...
4.  Explore the relationship between 2 variables in a plot. I would like
    to find relationship between *diagnosis* and *real_radius-mean*
    though jitter plot.
...
7.  Make a new tibble with a subset of your data, with variables and
    observations that you are interested in exploring. Create a new
    tibble containing data for worst malignant patients.
...
I wanted to see the distribution of the mean of the radius in breast
cancer patients.

#### Question 2.Create a new variable based on other variables in your data (only if it makes sense)

In this dataset, it appears that each patient has several images of
nuclei present in fine needle aspiration biopsies of breast cancer.
Consequently, for each variable, I observe both the **mean** and the
**standard error**. Therefore, I would like to generate a new type of
variable that contains the sum of these two types. I refer to this
variable as a **‘real’** variable because it includes both the mean and
the standard error. Also in diagnosis variable “B” stand for benign and
“M” is the abbreviation of malignant, I would like to have the compele
name in the new dataset, which I refer to this dataset as a
**real_dataset**

#### Question 3. Explore the relationship between 2 variables in a plot.

I would liked to find relationship between *diagnosis* and
*real_radius-mean* though scatterplot to see can I see any association
between the mean of the radius with cancer status(malignancy/benign).
Thereofre, I made a jitter plot to see better this difference.
...
> image differ between malignant diagnosis samples and a benign
> diagnosis samples?

> Question 2. Is there a difference in the mean perimeter of nuclei
> present in a sample image between malignant diagnosis samples and a
